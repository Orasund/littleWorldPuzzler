...
checkSwiped start end =
    (==) (getSwipedDirection start end)


getSwipedDirection : Coords -> Coords -> Direction
getSwipedDirection start end =
    if abs (start.clientX - end.clientX) > abs (start.clientY - end.clientY) then
        if start.clientX < end.clientX then
            Right

        else
            Left

    else if start.clientY < end.clientY then
        Down
